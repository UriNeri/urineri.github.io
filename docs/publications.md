...
!!! warning "preprint"
    **RdRpCATCH: A unified resource for RNA virus discovery using viral RNA-dependent RNA polymerase profile Hidden Markov models**  
    Dimitris Karapliafis, **Uri Neri**, Ingrida Olendraite, Justine Charon, Shoichi Sakaguchi, Xin Hou, Dick de Ridder, Mark P. Zwart, Anne Kupczok  
    ** (2026)  
    [DOI](https://doi.org/10.64898/2026.02.05.703936) | [BibTeX](https://api.crossref.org/works/10.64898/2026.02.05.703936/transform/application/x-bibtex)
...
!!! publication "Article"
    ...
    *Nature Reviews Microbiology* (2025)  
    [DOI](https://doi.org/10.1038/s41579-025-01253-z) | [BibTeX](https://api.crossref.org/works/10.1038/s41579-025-01253-z/transform/application/x-bibtex)
